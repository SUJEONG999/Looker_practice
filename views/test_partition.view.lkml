...
view: test_partition__sku {
  dimension: test_partition__sku {
    type: string
    sql: test_partition__sku ;;
  }
}

view: test_partition__category {
  dimension: test_partition__category {
    type: string
    sql: test_partition__category ;;
  }
}
...
view: test_partition__manufacturer {
  dimension: test_partition__manufacturer {
    type: string
    sql: test_partition__manufacturer ;;
  }
}
